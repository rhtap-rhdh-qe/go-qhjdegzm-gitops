...
export GITOPS_REPO_URL=https://github.com/rhtap-rhdh-qe/go-qhjdegzm-gitops
...
export COSIGN_PUBLIC_KEY="LS0tLS1CRUdJTiBQVUJMSUMgS0VZLS0tLS0KTUZrd0V3WUhLb1pJemowQ0FRWUlLb1pJemowREFRY0RRZ0FFSVR3TXA2RUhOUmpjczRSbmF4V3l0SE5hTmxlRgp1TTVDQm84YXA5R0ZnQytwYUR3VnZ6L1Znc253ckhkUXBrRjB2ZHBPbWU3SnluV2NMZTE1NzNFVGR3PT0KLS0tLS1FTkQgUFVCTElDIEtFWS0tLS0tCg=="
...
export REKOR_HOST=${REKOR_HOST-https://rekor-server-tssc-tas.apps.rosa.kx-3a26bc46e5.5fiz.p3.openshiftapps.com}
...
export TUF_MIRROR=${TUF_MIRROR-https://tuf-tssc-tas.apps.rosa.kx-3a26bc46e5.5fiz.p3.openshiftapps.com}
